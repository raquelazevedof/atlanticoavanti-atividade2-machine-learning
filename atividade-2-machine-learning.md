...
**4. Encontre o segundo maior valor de uma lista de inteiros.**
...
**5. Ordene uma lista de tuplas (nome, idade) pelo nome.**
...
### Exemplo: [("Ana",20),("Carlos",18),("Beatriz",25)]
...
Tratamentos comuns: remover outliers, substituir por mediana, ou ajustar valores.
...
**8. Como ler um arquivo CSV e exibir as primeiras linhas?**
...
**9. Selecionar uma coluna e filtrar linhas com condição.**
...
**10. Como lidar com valores ausentes (NaN)?**
